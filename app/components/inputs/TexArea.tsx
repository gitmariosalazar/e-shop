  ...
  return (
    <div className="w-full relative">
      <textarea
        ...
        placeholder=""
        className={`peer w-full p-4 pt-6 max-h-[150px] min-h-[150px] outline-none bg-while font-light border-2 rounded-md transition disabled:opacity-70 bg-slate-900 disabled: cursor-not-allowed ${
